...
var instrucciones = ["Utilizando las teclas de flecha de tu teclaldo",
                    "mueve las piezas",
                    "hasta completar de forma correcta la figura",
...
function mostrarInstrucciones(instrucciones) {
    ...
    instrucciones.forEach(element => {
      mostrarInstruccionEnLista(element, 'lista-instrucciones');
    });
}
...
function mostrarCartelGanador() {
    //COMPLETAR
    alertaGanadora = document.getElementById('alertaGanadora');
    alertaGanadora.style.display = "block";
...
function reiniciar() {
    //COMPLETAR
    alertaGanadora = document.getElementById('alertaGanadora');
    alertaGanadora.style.display = "none";
        mezclarPiezas(30);
...
function moverEnDireccion(direccion) {
  ...
  // console.log('columnaVacia ' + filaVacia);
  ...
  // console.log('nuevafila ' + nuevaFilaPiezaVacia);
